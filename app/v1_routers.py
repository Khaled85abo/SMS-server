...
from .routers import user_router, login_router, image_router, detection_router, item_router, box_router, workspace_router, rag_router, resources_router
...
v1_router.include_router(resources_router.router, prefix="/resources", tags=["resources"])
